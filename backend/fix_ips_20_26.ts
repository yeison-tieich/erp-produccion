...
async function main() {
  ...
  console.log(`Updating all old IPs to ${newIp} in database...`);

  // We can just replace 192.168.20.26 to 192.168.2.26
  const oldIp = '192.168.20.26';
  ...
  console.log('Database IP replacement complete for 192.168.20.26.');
}
